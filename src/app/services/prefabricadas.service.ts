...
export class PrefabricadasService {
  ...
  private prefabricadas: PrefabricadaModel[] = [
    // MODELOS 30
    {
      ...
      precio_lista: "$7.909.000",
      precio_contado: "$6.588.285",
      anticipo: "$2.701.197 ",
      numero_cuotas: 36,
      cuota: "$267.777", 
    },
    {
      ...
      precio_lista: "$6.611.459",
      precio_contado: "$5.509.548",
      anticipo: "$2.258.915 ",
      numero_cuotas: 36,
      cuota: "$223.932",
    },
    // MODELOS 36
    {
      ...
      planta: "36.jpg",
      video_url: "https://www.youtube.com/embed/NL7l_dOWIdY",
      precio_lista: "$9.499.000",
      precio_contado: "$7.905.942",
      anticipo: "$3.241.436",
      numero_cuotas: 36,
      cuota: "$321.333",
    },
    {
      ...
      planta: "36.jpg",
      video_url: "https://www.youtube.com/embed/ESB8UcNCg10",
      precio_lista: "$7.933.749",
      precio_contado: "$6.611.458 ",
      anticipo: "$2.710.699",
      numero_cuotas: 36,
      cuota: "$268.719",
    },
